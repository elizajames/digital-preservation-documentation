...
See [the Code documentation]({{ site.baseurl }}  
#mermaid-diagram-code-blocks) for more configuration options and information.
...
See [Navigation Structure]({{ site.baseurl }} 
#external-navigation-links) for more details.
...
See [Callouts]({{ site.baseurl }} for more information.
